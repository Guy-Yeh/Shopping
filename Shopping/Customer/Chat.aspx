        ...
        <div class="container">
            ...
            <div class="chat_grid">
                ...
                <div>
                    ...
                    <asp:GridView ID="chatGridView" style="border-collapse: collapse;width: 100%;" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" AllowPaging="true" onpageindexchanging="chatGridView_PageIndexChanging">
