		...
		<h1><span style="font-family:Microsoft JhengHei;">註冊</span></h1>
				 ...
				 <div class="col-md-6  register-top-grid">
					...
					<div class="mation">
						...
						<asp:TextBox ID="accountTex" runat="server"></asp:TextBox>
						...
						<asp:TextBox ID="passwordCheckText" runat="server"></asp:TextBox>
					 ...
					 <div class="clearfix"> </div>
					   ...
					   <a class="news-letter" href="#">
                         <asp:CheckBox ID="checkbox" runat="server" Text="註冊後登入"  />
				     ...
				     <div class=" col-md-6 register-bottom-grid">
							...
							<div class="mation">
								...
								<asp:Label ID="identity" runat="server" Text="身分證"></asp:Label>
								<asp:TextBox ID="identityText" runat="server"></asp:TextBox>
