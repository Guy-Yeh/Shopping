            ...
            <div class="container">
                <div class="content-top">
                    ...
                    <div class="content-top1">
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton2" runat="server"  Height="100%" Width="100%" OnClick="ImageButton2_Click" />
                                <div class="price">
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton3" runat="server"  Height="100%" Width="100%" OnClick="ImageButton3_Click" />
                                <div class="price">
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton4" runat="server"  Height="100%" Width="100%" OnClick="ImageButton4_Click" />
                                <div class="price">
                                    <asp:Label ID="Label6" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label7" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="category" DataValueField="category">
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton5" runat="server"  Height="100%" Width="100%" OnClick="ImageButton5_Click" />
                                <div class="price">
                                    <asp:Label ID="Label8" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label9" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList4" runat="server" DataSourceID="SqlDataSource4" DataTextField="category" DataValueField="category">
                                    </asp:DropDownList>
                    ...
                    <div class="content-top1">
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton6" runat="server"  Height="100%" Width="100%" OnClick="ImageButton6_Click" />
                                <div class="price">
                                    <asp:Label ID="Label10" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label11" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="SqlDataSource5" DataTextField="category" DataValueField="category">
                                    </asp:DropDownList>
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton7" runat="server"  Height="100%" Width="100%" OnClick="ImageButton7_Click" />
                                <div class="price">
                                    <asp:Label ID="Label12" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label13" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource6" DataTextField="category" DataValueField="category">
                                    </asp:DropDownList>
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton8" runat="server"  Height="100%" Width="100%" OnClick="ImageButton8_Click" />
                                <div class="price">
                                    <asp:Label ID="Label14" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label15" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList7" runat="server" DataSourceID="SqlDataSource7" DataTextField="category" DataValueField="category">
                                    </asp:DropDownList>
                        ...
                        <div class="col-md-3 col-md2">
                            <div class="col-md1 simpleCart_shelfItem">
                                <asp:ImageButton ID="ImageButton9" runat="server"  Height="100%" Width="100%" OnClick="ImageButton9_Click" />
                                <div class="price">
                                    <asp:Label ID="Label16" runat="server" Text=""></asp:Label>
                                    <asp:Label ID="Label17" runat="server" Text=""></asp:Label><br>
                                    <asp:DropDownList ID="DropDownList8" runat="server" DataSourceID="SqlDataSource8" DataTextField="category" DataValueField="category">
                                    </asp:DropDownList>
